...
opkg update  
opkg install block-mount kmod-fs-ext4 e2fsprogs parted kmod-usb-storage ncat pv gzip  coreutils-dd coreutils-mv openssh-sftp-server lsblk curl #luci-app-attendedsysupgrade luci cfdisk resize2fs 
